...
public class DocDTO {
   ...
   public DocDTO(int doc_id, Date doc_date, String id, String doc_title, String doc_content, String doc_attachment, Date doc_endDate, int category_id, String doc_status, char doc_read, String name) {
       this.doc_id = doc_id;
